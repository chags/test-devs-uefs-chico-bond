...
class UpdatePostRequest extends FormRequest
{
    ...
    {
        return [
            'title' => 'required|string|max:255', // Obrigatório, pois estamos usando PUT
            'content' => 'required|string',       // Obrigatório, pois estamos usando PUT
            'tags' => 'nullable|array',           // Tags são opcionais
            'tags.*' => 'nullable|string|max:255' // Cada tag deve ser uma string válida
        ];
    }
